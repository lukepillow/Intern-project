...
def getLinks(responseJSON):
	'''Gets the 25 links per page of listing.'''
...
def getPinIDs(responseJSON):
	...
	#print('The response was ', str(len(dataString)), ' characters long.')
	...
	for data in unformattedData:
		...
		# Sometimes the starting sequence is weird?
		# TO-DO, see when the starting sequence doesn't contain prefix
		elif length == 7:
			print('Found one.')
			results.add(data)
